               ...
               <div class="form-group">
                ...
                <div class="box-footer custom-box-footer">                
                  ...
                  <div class="btn-group pull-right">
                    <a class="btn btn-primary" href="{{ route('createUserProfile') }}"><i class="fa fa-user-plus"></i> Create</a>
                    <a class="btn btn-primary" href="{{ route('editUserProfile', ['id' => $user->id]) }}"><i class="fa  fa-edit"></i> Edit</a>
                    <a class="btn btn-primary" href="{{ route('confirmDeleteUserProfile', ['id' => $user->id]) }}"><i class="fa fa-trash"></i> Delete</a>
                  </div>
                </div>
                <!-- /.box-footer -->
              </div>
